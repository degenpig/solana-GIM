...
import { getGimmicks, getPlace } from '../../../utils/api';
import { GimmickDetail } from '../../../components/wiki/GimmickDetail';
import { WikiLayout } from '../../../components/wiki/WikiLayout';
import styles from './[placeID].module.scss';
  ...
  return (
    ...
    {(gimmickData && detail) ? (
      <WikiLayout 
        ...
        showLink={false} 
        linkFunction={() => router.push(`/wiki/places/edit/${placeID}`)}
        linkText="Edit"
        isReportable={false}
        reportID={placeID}
        reportLink={`www.therealgimmicks/wiki/gimmicks/${placeID}`}
      >
