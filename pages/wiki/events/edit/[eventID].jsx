...
import { getEvent, saveEvent, saveGimmick, updateGimmick } from '../../../../utils/api';
  ...
  const submitEdit = async() => {
    ...
    if (isOwner) {
      const res = await saveEvent(
        verifiedAddress, parseInt(eventID), 
        JSON.stringify(
          convertToRaw(
      ...
      if (res.status = 200) router.push(`/wiki/events/${eventID}`);
    }
